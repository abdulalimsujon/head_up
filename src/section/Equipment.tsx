...
// Reusable EquipmentSection Component
...
const Equipment = () => {
  ...
  return (
    <div
      id="equipment"
      className="w-full flex justify-center items-center px-4 md:px-6 mt-32"
    >
      <div className="w-full max-w-[1200px] flex flex-col">
        ...
        {/* Equipment Sections */}
        <div className="flex flex-col gap-12 md:gap-10 mt-12 md:mt-20">
          {equipmentData.slice(0, 2).map((section, index) => (
            <EquipmentCard
              key={index}
              title={section.title}
        ...
        <div className="w-full flex justify-center mt-12 md:mt-16">
          <CustomButton
            ...
            onClick={() => navigate("/equipment")} // Navigate to /equipment
          />
        </div>
      </div>
    </div>
